...
VCF_DIR="/media/user/PDAC_SEQ_analysis/results/sarek_tumor_normal/annotation/mutect2"
OUT_DIR="${3:-/media/user/PDAC_SEQ_analysis/results/cosmic_annotation_mutect2_v103}"
